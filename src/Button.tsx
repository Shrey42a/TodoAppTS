...
const Button: FC<ButtonProps> = ({theme, ...rest}) => {
  ...
  return(
    ...
    data-mdb-ripple-color="light" {...rest} className={"inline-flex justify-center px-4 py-2 text-sm font-medium mt-4 text-white bg-yellow-500 border border-transparent rounded-full shadow-zinc-600 shadow-sm hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 " + themeClasses + '  ' + radiusClass}>
     </button>
  );
}
